<?php	
	function Mailer($mail_nhan,$ten_nhan,$tieude,$tomtat,$noidung)
	{
		...
		$mail->Username   = "hung.khoapham@gmail.com"; // Tên đăng nhập tài khoản Gmail
		$mail->Password   = "hung@123"; //Mật khẩu của gmail
		$mail->SetFrom("hung.khoapham@gmail.com", "PHP Shop"); // Thông tin người gửi
		$mail->AddReplyTo("hung.khoapham@gmail.com","Php Shop");// Ấn định email sẽ nhận khi người dùng reply lại.
